...
class Canvas(QGraphicsView):
    ...
    def reset_for_project(self, project):
        """Reset all canvas-owned state before drawing a new project."""

        # Drop Python references before CanvasEngine clears/deletes scene items.
        self.selection_overlay = None
        self.current_selected_item = None
        ...
        # A new project starts from a clean viewport as well.
        self.resetTransform()
    ...
    def import_image(self, filename):
        # Importing a replacement image also invalidates the old selection UI.
        self.selection_overlay = None
        self.current_selected_item = None
